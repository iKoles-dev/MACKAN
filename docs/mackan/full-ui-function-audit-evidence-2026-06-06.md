...
| 2026-06-20T14:34:59+0300 | `swift test --package-path macosx/MACKAN` | exit 0 | Visual architecture hardening final gate: 332 tests passed, 0 failed. |
| 2026-06-20T14:35:00+0300 | `/opt/homebrew/bin/dotnet test Tests/Tests.csproj --filter MACKAN` | exit 0 | MACKAN .NET suite passed: 1451 passed, 0 failed; existing `SYSLIB0050` warnings only. |
| 2026-06-20T14:36:00+0300 | `macosx/MACKAN/scripts/test-accessibility-smoke.sh` | exit 0 | Accessibility smoke passed after updating the check for the extracted `MainWindowToolbar.swift` launch label. |
| 2026-06-20T14:36:00+0300 | `macosx/MACKAN/scripts/build-dev-app.sh` | exit 0 | Built `/Users/elijahn/Library/Caches/MACKAN/build/MACKAN.app`; existing `SYSLIB0050` warnings only. |
| 2026-06-20T14:37:00+0300 | `macosx/MACKAN/scripts/verify-app-launch.sh --timeout 30 /Users/elijahn/Library/Caches/MACKAN/build/MACKAN.app` | exit 0 | Verified GUI launch without Terminal and with one visible window. |
| 2026-06-20T14:37:17+0300 | `macosx/MACKAN/scripts/run-ui-ux-audit.sh --wait-catalog 60 --output /tmp/mackan-visual-architecture-hardening-final /Users/elijahn/Library/Caches/MACKAN/build/MACKAN.app` | exit 0 | Captured target-window main/minimum/medium/wide screenshots plus metadata. Catalog readiness mode was `inconclusive-wait`. |
| 2026-06-20T14:38:00+0300 | `macosx/MACKAN/scripts/verify-ui-ux-audit-evidence.sh /tmp/mackan-visual-architecture-hardening-final` | exit 1 | Expected for this visual-only pass: full verifier rejected the incomplete mandatory functional checklist at `Instances: add, clone, fake, rename, forget, set default, reveal folder, launch warnings.` |
| 2026-06-20T14:39:00+0300 | `macosx/MACKAN/scripts/verify-ui-ux-audit-evidence.sh --capture-only /tmp/mackan-visual-architecture-hardening-final` | exit 0 | Screenshot, target-window, metadata, launch evidence, and window summary integrity passed. |
| 2026-06-20T14:39:00+0300 | `macosx/MACKAN/scripts/release-check.sh --skip-launch` | exit 0 | Non-credential release gate passed, including Swift, .NET MACKAN route tests, vulnerability checks, script tests, accessibility smoke, universal package build, DMG verification, provenance, and release artifact verification. |
...
| 2026-06-07T06:20:00+0300 | `CAT-COLUMN-002` | Hardened catalog header hit targets for focused retest | Sortable headers now expose a full-cell hit target plus stable `CatalogGridIdentityPolicy` accessibility identifiers for header/module cells. `CatalogGridIdentityPolicyTests` passed 2/2 and full `swift test --package-path macosx/MACKAN` passed 305/305. Live header-click confirmation remains blocked by the macOS privacy prompt. |
...
| 2026-06-20 visual architecture hardening screenshots and metadata | `/tmp/mackan-visual-architecture-hardening-final/main-window.png`; `/tmp/mackan-visual-architecture-hardening-final/adaptive-minimum.png`; `/tmp/mackan-visual-architecture-hardening-final/adaptive-medium.png`; `/tmp/mackan-visual-architecture-hardening-final/adaptive-wide.png`; `/tmp/mackan-visual-architecture-hardening-final/audit-metadata.json`; `/tmp/mackan-visual-architecture-hardening-final/window-summary.txt`; `/tmp/mackan-visual-architecture-hardening-final/launch-smoke.txt`; `docs/mackan/release-readiness-evidence-2026-06-20-visual-architecture-hardening.md` | `APP-STARTUP-001`; `WIN-TOOLBAR-001`; adaptive layout; visual architecture hardening |
